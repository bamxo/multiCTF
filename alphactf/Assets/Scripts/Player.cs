    ...
    public class Player : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        private void Start()
        {
            ...
            if (!photonView.IsMine)
            {
                ...
                ChangeLayerRecursively(mesh.transform, 13);
            }
        ...
        void Update()
        {
            ...
            bool isCrouching = crouch && !isSprinting && !isJumping;
            ...
            if (Input.GetKeyDown(KeyCode.U)) TakeDamage(250);
        ...
        { 
            ...
            bool sprint = Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift);
            bool jump = Input.GetKeyDown(KeyCode.Space);
            bool slide = Input.GetKeyDown(KeyCode.V);
